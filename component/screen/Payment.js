      ...
      <ScrollView style={styles.content}>
        ...
        >
          ...
          <View style={styles.radioContainer}>         
            ...
            <Text style={styles.optionText}>
              Mời quý khách đến quầy lễ tân đóng tiền theo <br/>  
              hóa đơn trên ứng dụng. Sau khi thanh toán, <br/>
              hóa đơn điện tử sẽ được kiểm tra và gửi đến <br/> 
        ...
        >
          ...
          <View style={styles.radioContainer}>
            ...
            <Text style={styles.optionText}>
              Quý khách vui lòng chuyển khoản theo <br/>thông tin dưới đây: {'\n'}
        ...
        > 
          ...
          <View style={styles.radioContainer}>          
            ...
            <Text style={styles.optionText}>
              Chuyển khoản ngân hàng trực tuyến qua <br/>ứng dụng Momo 
            </Text>
          </View>
